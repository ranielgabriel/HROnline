...
if ($_SERVER['REQUEST_METHOD'] == 'GET') {
	...
	if(isset($_GET['position']) and $_GET['position'] != ''){
		...
		$response['code'] = "<input readonly type='text' id='positionApplying' class='form-control' value='" . $position . "'>";
		...
		// Put the HTML code in the code JSON variable
		$response['code'] = "<select id='positionApplying' class='select form-control'><option disabled selected value=''>Select Position</option>" . $positionsToDisplay . "</select><div id='positionErrorMessage' style='display: none; color: red;'>Select your position here.</div>";
