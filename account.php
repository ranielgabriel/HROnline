...
?>
	...
	?>
			...
			<div id="main">
				<h5 style="cursor:pointer; color:#00008B; font-family:'Trebuchet MS', Helvetica, sans-serif; padding-top:10px; padding-right:10px; padding-left:10px;"
				    onclick="openNav()">
					<i class="fa fa-bars"></i> Menu </h5>
				<div class="row">
						...
						<div class="row" style="text-align: center padding-top:50px">
							<div class="col-md-4">
								<div class="col-md-12 card">
									...
									?>
										<form role="form" name="admindetails">
										...
										<form role="form" name="accountform">
											...
											<div class="form-group">
												...
												<div class="col-md-8">
													...
													<h6>
														<span class="text-danger" id="passwordnotice1"></span>
													</h6>
												</div>
											</div>
											<div class="form-group" id="cnewpassword">
												...
												<div class="col-md-8">
													...
													<h6>
														<span class="text-danger" id="passwordnotice2"></span>
													</h6>
												</div>
											</div>
											<div class="form-group">
											...
											<div class="form-group" id="cnewemailpassword">
												...
												<div class="col-md-8">
													...
													<h6>
														<span class="text-danger" id="epasswordnotice2"></span>
													</h6>
												</div>
											</div>
											<div class="form-group">
							...
							<div class="col-md-4">
								<div class="col-md-12 card">
									<legend>
										<br> Rollback</legend>
									<div class="form-group">
										<button style="margin-top: 60%;" data-toggle='modal' data-target='#myModal' type="button" name="" class="btn btn-raised btn-danger btn-sm pull-right">Rollback
										...
										<div class="modal-dialog">
											<div class="modal-content">
												<div class="modal-header" style="background-color: #ff4d4d">
													...
													<p style="color:white">Remove batch of rows of applications
														<!--from recently uploaded CSV-->
													</p>
												</div>
								...
								<div class="col-md-12 card">
									<form>
										...
										<div class="form-group">
											...
											<div class="col-md-1"></div>
											<div class="col-md-8">
												<textarea id="newemailmessage" class="form-control" style="height: 128px">
													<?php echo $row['email_message'] ?>
												</textarea>
											</div>
										</div>
