...
if(isset($_GET['iNt3RvI3w3r'])){
	...
	echo'$("#workcomment").prop("disabled", true);'; //comment box
...
while($row = $resultS->fetch_assoc()){
	...
	$position = $row["POSITION"];
	 ...
	 $contractual = $row["CONTRACTUAL_EMPLOYMENT"];
	 ...
	 $workcomment1 = $row["1.7 WorkComment"];

	 $workcomment2 = $row["2.7 WorkComment"];

	 $workcomment3 = $row["3.7 WorkComment"];

	 $workcomment4 = $row["4.7 WorkComment"];

	 $workcomment5 = $row["5.7 WorkComment"];
				...
				<div class="row col-md-12">
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							...
							<label>Are You amenable to contractual employment?</label>

							<div class="radio radio-primary">

							  <label>

								<input type="radio" name="cont" id="cont2" value="YES" <?php if($contractual=='YES')echo'checked';?>>
							  ...
							  <label>
								...
								<input type="radio" name="cont" id="cont2" value="NO" <?php if($contractual=='NO')echo'checked';?>>
						...
						<div class="form-group" id="salary_group" ><!-- SALARY -->
							...
							<div class="input-group">
								...
								<select id="salary" class="select form-control" name="salaryexpectation" >
									...
									<option value="More than 55,000.00" <?php if($salary == 'More than 55,000.00')echo'selected'?>>More than &#8369;55,000.00</option>
							...
							<div class="col-md-6">
								...
								<div class="form-group label-floating">
									...
									<select id="source" name="sourcex" class="select form-control" onchange="showsource(this)">
										...
										<?php if($app_source!='Twitter'&&$app_source!='My Opportunity'&&$app_source!='Linked In'&&$app_source!='Indeed'&&$app_source!='Facebook'&&$app_source!='Referral'&&$app_source!='Jobstreet')
										{
											echo '<option value="'.$app_source.'">'.$app_source.'</option>';
										}?>
					...
					<!--  -->
						...
						<div class="col-md-6">
							...
							<div class="form-group label-floating">
								...
								<input class="form-control" value="<?php echo $contact_details;?>" data-inputmask="'mask': '(+999) 999-999-9999'" type="text" name="contact_details" id="contactpersonno" onkeypress="return (event.charCode == 8 || event.charCode == 0) ? null : event.charCode >= 48 && event.charCode <= 57" required>
							...
							<div class="row col-md-12">
							  ...
							  <div class="col-md-2">
								...
								<div class="form-group label-floating">
								  ...
								  <input class="form-control" type="text" value="'.$row['1.6 Emp_phone'].'" name="contactnum" id="employers_contact_number" data-inputmask=""mask": "(99)-999-9999"" onkeypress="return (event.charCode == 8 || event.charCode == 0) ? null : event.charCode >= 48 && event.charCode <= 57" maxlength="11">
							  ...
							  <div class="col-md-2">
								...
								<div class="form-group label-floating">
								  ...
								  <input class="form-control" type="text" value="'.$row["1.4 Monthly Salary"].'" name="salary" id="monthlysalary">
							  ...
							  <div class="form-group">
								...
								<div class="form-group label-floating">
									...
									<label for="workcomment" style="color:blue;">Comment Box</label>

									<textarea class="form-control" rows="5" name="workcomment" id="workcomment" style="color:blue;" >'.$workcomment1.'</textarea>
							...
							<div class="row col-md-12">
							  ...
							  <div class="col-md-2">
								...
								<div class="form-group label-floating">
								  ...
								  <input class="form-control" type="text" value="'.$res_con2[1].'" name="contactnum2" id="employers_contact_number">
							  ...
							  <div class="form-group">
								...
								<div class="form-group label-floating">
									...
									<label for="workcomment" style="">Comment Box</label>

									<textarea class="form-control" rows="5" name="workcomment2" id="workcomment" style="color:blue;" >'.$workcomment2.'</textarea>
							...
							<div class="row col-md-12">
							  ...
							  <div class="col-md-2">
								...
								<div class="form-group label-floating">
								  ...
								  <input class="form-control" type="text" value="'.$res_con3[1].'" name="contactnum3" id="employers_contact_number">
							  ...
							  <div class="form-group">
								...
								<div class="form-group label-floating">
									...
									<textarea class="form-control" rows="5" name="workcomment3" id="workcomment" style="color:blue;" >'.$workcomment3.'</textarea>
							...
							<div class="row col-md-12">
							  ...
							  <div class="col-md-2">
								...
								<div class="form-group label-floating">
								  ...
								  <input class="form-control" type="text" value="'.$res_con4[1].'" name="contactnum4" id="employers_contact_number">
							  ...
							  <div class="form-group">
								...
								<div class="form-group label-floating">
									...
									<textarea class="form-control" rows="5" name="workcomment4" id="workcomment" style="color:blue;" >'.$workcomment4.'</textarea>
							...
							<div class="row col-md-12">
							  ...
							  <div class="col-md-2">
								...
								<div class="form-group label-floating">
								  ...
								  <input class="form-control" type="text" value="'.$res_con5[1].'" name="contactnum5" id="employers_contact_number">
							  ...
							  <div class="form-group">
								...
								<div class="form-group label-floating">
									...
									<textarea class="form-control" rows="5" name="workcomment5" id="workcomment" style="color:blue;" >'.$workcomment5.'</textarea>
							...
							<div class="row col-md-12">
							  ...
							  <div class="col-md-2">
								...
								<div class="form-group label-floating">
								  ...
								  <input class="form-control" type="text"  name="contactnum" id="employers_contact_number">
